...
#define SONY_IR_MIC_SWITCH			0x50
#define SONY_IR_MIC_MUTE			0x51
#define SONY_IR_AI					0x52
#define SONY_IR_VOL_INC				0x53
#define SONY_IR_VOL_DEC				0x54
...
inline static void TransPicCmd(uint32_t cmd)
{
    ...
    switch(cmd & 0x7F)
    {
		...
		case SONY_IR_MIC_SWITCH:        cmd_t |= IR_CMD_MIC_SWITCH;     break;
		case SONY_IR_MIC_MUTE:          cmd_t |= IR_CMD_MIC_MUTE;       break;
		case SONY_IR_AI:                cmd_t |= IR_CMD_AI;             break;
		case SONY_IR_VOL_INC:           cmd_t |= IR_CMD_VOL_INC;        break;
		case SONY_IR_VOL_DEC:           cmd_t |= IR_CMD_VOL_DEC;        break;
        default:                        cmd_t = 0;                      break;
    }
